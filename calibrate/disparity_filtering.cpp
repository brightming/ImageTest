...
const String keys =
    ...
    "{@left          |left-rectify.jpeg | left view of the stereopair                                       }"
    "{@right         |right-rectify.jpeg | right view of the stereopair                                      }"
    "{GT             |../data/aloeGT.png| optional ground-truth disparity (MPI-Sintel or Middlebury format) }"
    "{dst_path       |filterd_disp.jpeg | optional path to save the resulting filtered disparity map        }"
    "{dst_raw_path   |raw_disp.jpeg     | optional path to save raw disparity map before filtering          }"
