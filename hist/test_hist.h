...
// 1.8米高，倾斜45度,0.6m(宽)*0.8m(长)*0.12m(高)托架配置表
           {0,     1490,       950,    430/*360*/,     0,               {10.50,0.26}/*{10.39,0.26}*/,              64,              16,       {8,4},      {16,16},    {8,4},        {8,8},      0,  {1.2,0.7,1.05}},  // 0.3m ~0.6m
           {5,     1140,       950,     400/*320*/,     0,              {8.77,0.29},              64,              16,       {8,4},      {8,8},    {8,4},        {8,8},      0,   {1.2,0.6,1.05}},  // 0.7m ~1.2m
           {5,     980,      950,     260,     0,                 {7.6,0.28},             64,              16,       {8,4},      {16,16},    {4,4},        {8,8},     0,            {1.2,0.7,1.15}},  // 1.3m ~1.6m
           {5,       810,      950,     300,     0,               {6.625,0.28},             64,              16,       {8,4},      {16,16},    {4,4},        {8,8},       0,        {1.2,0.7,1.15}},  // 1.7m ~2.1m
           {5,       600,      950,     370,     0,               {5.62,0.271}/*{5.59,0.271}*/,             64,              16,       {8,4},      {16,16},    {4,4},        {8,8},       0         ,{1.3,0.7,1.05}},  // 2.2m ~2.8m
           {100,     530,      850,     290,     0,              {4.76,0.36},              64,              16,       {8,4},      {16,16},    {8,4},        {8,8},       4           ,{1.2,0.8,1.05}},  // 2.9m ~3.5m
           {140,     450,       800,     280,      0,            {4.08,0.35},                64,              16,       {8,4},      {16,16},    {4,4},      {8,8},      6            ,{1.2,0.8,1.05}},  // 3.6m ~4.2m
           {240,     390,       700,     240,      0,            {3.61,0.458},               64,             16,        {8,4},      {16,16},   {8,4},         {8,8},      5          ,{1.2,0.9,1.05}},  // 4.3m ~4.9m
           {300,     320,       440,     270,     0,             {2.9,0.516},               64,             16,        {8,4},      {16,16},   {8,4},         {8,8},      6           ,{1.3,0.8,1.05}},  // 5.0m ~5.9m
           {350,     270,       390,     270,     0,             {2.72,0.58},               64,             16,        {8,4},      {16,16},   {8,4},         {8,8},      6            ,{1.5,0.7,1.05}},  // 6.0m ~6.9m
           {370,     230,        370,     120,     0,            {2.02,0.625}/*{2.32,0.625}*/,               64,             16,        {8,4},      {16,16},   {4,4},         {8,8},      6           ,{1.4,0.7,1.05}},  // 7.0m ~7.7m
