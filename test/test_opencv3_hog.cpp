...
App::App(const Args& s)
{
    ...
    cout << "ratio_height: " << ratio_height << endl;
    cout << endl;
}
...
//        }
    ...
    while (running)
    {
        ...
        {
            int frame_need_height=ratio_height*frame.rows;
            int offset_height=(1-ratio_height)*frame.rows;
            if(frame_need_height+offset_height>frame.rows){
                frame_need_height=frame.rows-offset_height;
            }
//            cout<<"ratio_height="<<ratio_height<<",frame_need_height="<<frame_need_height<<",frame.rows="<<frame.rows<<endl;
            frame=frame(Rect(0,offset_height,frame.cols,frame_need_height));
